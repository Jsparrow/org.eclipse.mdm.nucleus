...
public class EntityService {
    ...
    public <T extends Entity> Option<T> find(String sourceName, Class<T> entityClass, String id,
        ...
        if (contextType != null) {
            ...
            if (entityClass.equals(CatalogAttribute.class)) {
                ...
                Option<TemplateComponent> templateComponent =
                        find(sourceName, TemplateRoot.class, parentIds[0], contextType).map(tplRoot -> Stream
                                .ofAll(tplRoot.getTemplateComponents()).find(tplComp -> tplComp.getID()
            ...
            return getEntityManager(sourceName)
                    ...
                    .mapTry(em -> em.load(entityClass, contextType, id)).toOption();
        }
        ...
        return getEntityManager(sourceName)
                // TODO handle "Entity not found"
                .mapTry(em -> em.load(entityClass, id)).toOption();
    }
     ...
     * @return the found EntityManager. Throws {@link MDMEntityAccessException} if not found.
     */
